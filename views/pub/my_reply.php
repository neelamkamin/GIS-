...
<?php echo "All Task-Reply by :-  <b>".  $s_id . "</b>,<br>"; ?>
...
<table class="table table-hover">
  ...
  <?php 
   ...
   $sql_join ="SELECT * FROM task_db JOIN reply_db ON reply_db.task_id=task_db.t_id WHERE reply_by='$s_id' ORDER BY reply_db.r_id DESC";
  ...
  <tbody>
    <tr class="table-default">
	      ...
	      <td>
	      	...
	      	<?=  
 				 form_submit('submit','Delete',array('onclick' => "return confirm('WARNING :- Do you really want to Delete your Reply')",'class'=>'btn btn-danger float-center')),
 					form_close();
 			?>
	      </td>
    </tr>
